...
class DetailsModel {
  ...
  Map<String, dynamic> toJson() {
    ...
    final belongsToCollection = this.belongsToCollection;
    ...
    final productionCompanies = this.productionCompanies;
    if (productionCompanies != null) {
      map['production_companies'] = productionCompanies.map((v) => v.toJson()).toList();
    }
    final productionCountries = this.productionCountries;
