...
import 'package:pop_corn_flix/views/player_screen.dart';
...
class FeaturetteScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
     ...
     var filteredList = ref.watch(MovieController.movieVideosProvider(VideoType(movieId: movieId,videoType: "Featurette")));
